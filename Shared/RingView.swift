            ...
            GeometryReader { geometry in
                ...
                ScrollView {
                    VStack{
                        ...
                        WaterTracingBarChart(chartData: self.healthKitManager.drinkDayData, dateComponents: .hour, mainTitle: "Day Tracer", subTitle: "Showing last 24 hours data", config: self.config)
                            .padding()
                            .onAppear() {
                                Task{
